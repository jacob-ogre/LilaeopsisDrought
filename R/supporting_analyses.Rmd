...
```{r fig-6, fig.height = 3, fig.width = 3, fig.cap = "**As expected, the density of _Lilaeopsis_ leaves was higher for the "high" treatment than for the the "low" treatment.**", echo = FALSE,  warning=FALSE, message=FALSE, cache=TRUE}
